    ...
    <BottomSheet bottomSheetRef={bottomSheetRef} snapPoints={['50%']} onClose={() => {
      ...
      <View className="px-4 pt-2">
        ...
        <View className="flex-row items-center justify-between mb-6">
          <Text className="text-2xl  text-foreground dark:text-foreground-dark">{title}</Text>
        ...
        <View className="gap-4">
          <View className="items-center mb-6">
            <View className="flex-row items-center gap-4">
              ...
              <Text className="text-3xl  text-foreground dark:text-foreground-dark mb-8">:</Text>
          ...
          <View className="mb-4">
            ...
            <View className="flex-row gap-2">
              ...
              />
              <Text className="text-xl  text-foreground dark:text-foreground-dark self-center">:</Text>
              <Input
                value={minutes}
                onChangeText={(text) => {
                  const num = parseInt(text, 10);
